			...
			<div class="fiveten wide column">
				<div class="ui segment aligned center">
					...
					<div class="ui steps">
						...
						<div class="ui step active ustedaqui" data-content="¡Que buen nombre! ¡Ya falta poco!">
						...
						<div class="column">
							<div class="ui segment green">
								...
								<div class="ui form red segment">
									...
									<a href="datosadmin.php" class="ui animated green fade button floated right">
										<div class="visible content">Vamos a por el último paso</div>
										<div class="hidden content">¡Que buen nombre!</div>
									</a>
								</div>
							</div>
						</div>
