			...
			<div class="fiveten wide column">
				<div class="ui segment aligned center">
					...
					<div class="ui steps">
						...
						<div class="ui step active ustedaqui" data-content="¡Pero si ya estamos en el final!">
								...
								<div class="ui form red segment">
									<div class="field">
										...
										<div class="ui left labeled icon input">
											<input type="text" placeholder="Nombre que se utilizará para acceder a la aplicación">
											<i class="user icon"></i>
										</div>
									</div>
									<div class="field">
									...
									<div class="field">
										...
										<div class="ui left labeled icon input">
											<input type="text" placeholder="Deje este campo en blanco para utilizar el de usuario">
											<i class="edit icon"></i>
										</div>
									</div>
									<a href="datosapp.php" class="ui animated green fade button floated right">
										<div class="visible content">Finalizar</div>
										<div class="hidden content">Instalando</div>
									</a>
								</div>
							</div>
						</div>
